...
int32_T Battery_Model_981c414b_1_ds_tdxy_p ( const NeDynamicSystem * LC ,
...
( void ) t1 ; ( void ) LC ; out = t2 -> mTDXY_P ; out . mNumCol = 116ULL ;
out . mNumRow = 22ULL ; for ( b = 0 ; b < 117 ; b ++ ) { out . mJc [ b ] =
